    ...
    for (const product of products) {
      ...
      try {
        const productPayload = {
          ...
          status: 'published',
          // Images in Medusa 2.0 creation can be simple strings in the array if they are already hosted
          images: product.images.map((img) => ({ url: `http://localhost:3006${img}` })),
